...
export const FooterPage = () => {
    return (
        <footer>
            <div className="max-w-7xl grid grid-cols-5 gap-8 mx-auto">
                <div>
                    <h2 className="text-[16px] py-2">Hỗ trợ khách hàng</h2>
                    <p className="text-[#808089] text-[11px]">
                        Hotline: <span className="text-[#38383D]">1900-6035</span> <br />
                ...
                <div>
                    <h2 className="text-[16px] py-2">Về Tiki</h2>
                    <p className='text-[#808089] text-[11px]'>
                        Giới thiệu Tiki <br />
                        Tuyển dụng <br />
                ...
                <div>
                    <h2 className="text-[16px] py-2">Hợp tác và liên kết</h2>
                    <p className="text-[#808089] text-[11px]">
                    Quy chế hoạt động Sàn GDTMĐT<br />
                    Bán hàng cùng Tiki <br />
                    </p>
                    <h2 className="text-[16px] py-3">Chứng nhận bởi</h2>
                ...
                <div>
                <h2 className="text-[16px] py-2">Phương thức thanh toán</h2>
                <div className="grid grid-cols-5 gap-2">
                    ...
                    <img src="/img/lg8.png" alt="" />
                    <img src="/img/lg9.png" alt="" />
                    <img src="/img/lg10.png" alt="" />
                    <img src="/img/lg11.png" alt="" />
                    <img src="/img/lg12.png" alt="" />
                </div>
                <h2 className="text-[16px] py-5">Dịch vụ giao hàng</h2>
                <img src="/img/lg13.png" alt="" />
                </div>

                <div>
                    <h2 className="text-[16px] py-2">Phương thức liên hệ</h2>
                    <div className="grid grid-cols-5 gap-2">
                        <img src="/img/fb.png" alt="" />
                        <img src="/img/youtobe.png" alt="" />
                        <img src="/img/zalo.png" alt="" />
                    </div>
                    <h2 className="text-[16px] py-2">Tải ứng dụng trên điện thoại</h2>
            ...
            <div className="max-w-7xl mx-auto my-3">
                    <hr />
                    <p className="text-[11px] text-[#808089] py-3">
                        Trụ sở chính: Tòa nhà Viettel, Số 285, đường Cách Mạng Tháng 8, phường 12, quận 10, Thành phố Hồ Chí
                        Minh <br />
                        Tiki nhận đặt hàng trực tuyến và giao hàng tận nơi, chưa hỗ trợ mua và nhận hàng trực tiếp tại văn phòng
                        hoặc trung tâm xử lý đơn hàng <br />

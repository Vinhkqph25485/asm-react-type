...
import { SimilarProduct } from '../components/product_detail/SimilarProduct'
import { DetailProPage } from '../components/product_detail/DetailProPage'
        ...
        <div className="grid grid-cols-[444px,auto] gap-8">
            <div className="border-r px-8">
                <div className="text-center px-8">
                    <img src={currentProduct?.image} alt="" width="444" height="444"/>
                </div>
            ...
            <div>
                ...
                <h2 className="text-[23px]">{currentProduct?.name}</h2>
                ...
                <div className="text-[#FF424E] px-5 py-5 border-b">
                    <span className="px-1 text-[32px]">{currentProduct?.price}<span className="underline">đ</span></span>
